...
def searchDiary(searchText,listbox,content,tk,imageLabel): # 일기장 검색 함수
...
def viewDiaryList(): #일기 보기 함수
    ...
    searchBtn = tkinter.Button(diaryList, text='검색', width=7, command=lambda:searchDiary(searchEntry.get(),inputListBox,outputLabel,diaryList,imagelabel)).place(x=215, y=15)  # 검색버튼
